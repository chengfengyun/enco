...
function SOLVE_THE_PAIR(self, opposite)
	print("------------------------------------------------")
	print("    Self:", self.Self_Type, self.Oppo_Type)
	print("Opposite:", opposite.Self_Type, opposite.Oppo_Type)

	if( self.Self_Type & opposite.Oppo_Type ~= 0 and
	    self.Oppo_Type & opposite.Self_Type ~= 0) then
		print('\t*Selected')
		return 1.0
	end
