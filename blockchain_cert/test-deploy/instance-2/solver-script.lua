...
function SOLVE_THE_PAIR(self, opposite)
	print("------------------------------------------------")
	print("    Self:", self.Self_TechType, self.Oppo_TechType)
	print("Opposite:", opposite.Self_TechType, opposite.Oppo_TechType)

	if( self.Self_TechType & opposite.Oppo_TechType ~= 0 and
	    self.Oppo_TechType & opposite.Self_TechType ~= 0) then
		print('\t*Selected')
		return 1.0
	end
