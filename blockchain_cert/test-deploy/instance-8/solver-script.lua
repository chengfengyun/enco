...
function SOLVE_THE_PAIR(self, opposite)
	print("------------------------------------------------")
	print("    Self:", self.A1, self.A2, self.B1, self.B2)
	print("Opposite:", opposite.A1, opposite.A2, opposite.B1, opposite.B2)	
	
	if( math.abs(self.A1 - opposite.B1) <= 20
	and math.abs(self.A2 - opposite.B2) <= 10
	and math.abs(self.B1 - opposite.A1) <= 20
	and math.abs(self.B1 - opposite.A1) <= 10) then
		print('\t*Selected')
		return 0.6
	end	
