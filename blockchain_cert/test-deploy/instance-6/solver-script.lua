...
function SOLVE_THE_PAIR(self, opposite)
	print("------------------------------------------------")
	print("    Self:", self.Self_World, self.Oppo_World)
	print("Opposite:", opposite.Self_World, opposite.Oppo_World)

	if( self.Self_World & opposite.Oppo_World ~= 0 and
	    self.Oppo_World & opposite.Self_World ~= 0) then
		print('\t*Selected')
		return 1.0
	end
