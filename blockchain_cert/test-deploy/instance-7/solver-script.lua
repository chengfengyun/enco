...
function SOLVE_THE_PAIR(self, opposite)
	print("------------------------------------------------")
	print("    Self:", self.Self_WorkExp, self.Oppo_WorkExp)
	print("Opposite:", opposite.Self_WorkExp, opposite.Oppo_WorkExp)

	if( self.Self_WorkExp >= opposite.Oppo_WorkExp - 0.5 and
	    opposite.Self_WorkExp >= self.Oppo_WorkExp - 0.5) then
		print('\t*Selected')
		return 1.0
	end
